 ...
 * Represents a request to move stock from one Warehouse to another within the same center.
 *
...
public class InventoryTransfer extends BaseEntity {
    ...
    public void setFromWarehouseId(final Long fromWarehouseId) {
    ...
    public void setToWarehouseId(final Long toWarehouseId) {
