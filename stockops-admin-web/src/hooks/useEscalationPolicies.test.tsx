...
describe('useActiveAlerts', () => {
  ...
  it('fetches pending alerts', async () => {
    const mockAlerts: PendingAlert[] = [
      { id: 1, alertType: 'TEMPERATURE', centerId: 1,  sensorId: 1, message: 'Too hot', severity: 'HIGH', status: 'PENDING', currentLevel: 1, acknowledgedAt: null, acknowledgedBy: null, createdAt: '', updatedAt: '' },
    ]
...
describe('useAcknowledgeAlert', () => {
  ...
  it('acknowledges alert and invalidates cache', async () => {
    const mockAlert: PendingAlert = {
      id: 1, alertType: 'TEMPERATURE', centerId: 1,  sensorId: 1,
