    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow mb-4">
        ...
        {isLoading ? (
          ...
          <EmptyState
            title="표시할 재고가 없습니다"
            description="입고 확정 후 창고와 LOT 단위의 재고가 표시됩니다."
              ...
              <table className="w-full">
                <thead className="bg-neutral-50 border-b border-neutral-200">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">창고</th>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div>
                          ...
                          <div className="text-sm text-neutral-500">{item.warehouseName}</div>
                        </div>
                      </td>
              ...
              {paginatedInventory.map((item: Inventory) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <span className="text-neutral-500 block">창고</span>
